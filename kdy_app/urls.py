...
urlpatterns = [
    ...
    path('my_page/update/<int:id>/username', views.my_page_update_username, name='my_page_update_username'),
    path('my_page/update/<int:id>/email', views.my_page_update_email, name='my_page_update_email'),
    path('my_page/update/<int:id>/password', views.my_page_update_password, name='my_page_update_password'),
    path('my_page/update/<int:id>/name', views.my_page_update_user_name, name='my_page_update_user_name'),
    path('my_page/update/<int:id>/phone', views.my_page_update_user_phone, name='my_page_update_user_phone'),
    path('my_page/update/<int:id>/address', views.my_page_update_user_address, name='my_page_update_user_address'),
    path('my_page/update/<int:id>/preferred_region_no', views.my_page_update_preferred_region_no, name='my_page_update_preferred_region_no'),
    path('my_page/update/<int:id>/preferred_accommodation_type_no', views.my_page_update_preferred_accommodation_type_no, name='my_page_update_preferred_accommodation_type_no'),
    path('my_page/update/<int:id>/preferred_tour_theme_type_no', views.my_page_update_preferred_tour_theme_type_no, name='my_page_update_preferred_tour_theme_type_no'),
