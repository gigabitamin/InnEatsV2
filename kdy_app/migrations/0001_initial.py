# Generated by Django 4.2.6 on 2023-10-22 07:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('daily_hotel_room_type', models.CharField(blank=True, max_length=20, null=True)),
                ('daily_hotel_num', models.CharField(blank=True, max_length=20, null=True)),
                ('daily_hotel_review_clear', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True)),
                ('daily_hotel_review_location', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True)),
                ('daily_hotel_review_service', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True)),
                ('daily_hotel_review_facility', models.DecimalField(blank=True, decimal_places=1, max_digits=3, null=True)),
        ...
        migrations.CreateModel(
            name='GoodchoiceJejuAnsi',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('숙소명', models.TextField(blank=True, null=True)),
                ('주소', models.TextField(blank=True, null=True)),
                ('이미지_링크', models.TextField(blank=True, db_column='이미지 링크', null=True)),
                ('별점', models.FloatField(blank=True, null=True)),
                ('가격', models.TextField(blank=True, null=True)),
                ('객실_종류', models.TextField(blank=True, db_column='객실 종류', null=True)),
                ('남은_객실', models.TextField(blank=True, db_column='남은 객실', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('naver_bloger_name', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('youtube_content_date', models.CharField(blank=True, max_length=50, null=True)),
            ],
            options={
                'db_table': 'youtube',
                'managed': False,
        ...
        migrations.CreateModel(
            name='NearAttraction',
            fields=[
                ('place', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='kdy_app.place')),
            ],
            options={
